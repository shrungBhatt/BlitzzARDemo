...
public class Engine extends Renderable {
    ...
    public Engine(Context context) {
        ...
        Object3d object3d = Util.getObject3d(context, Const.OBJECT_ENGINE);
    ...
    public void loadTexture() {
        mTextureHandle = loadTexture(mContext, R.drawable.engine_texture);
    }
    ...
    public void onDrawFrame(float deltaX, float deltaY, Interface_ResetAngle interfaceResetAngle) {
        ...
        Matrix.rotateM(mRotationMatrix,0,-40,0.0f,0.0f,1.0f);
