...
@TargetApi(22)
public class BlitzzCamera2 implements Camera {

    private static final String TAG = "BlitzzCamera2";
    ...
    public BlitzzCamera2(Context context, CameraCallback callback, int frameWidth, int frameHeight) {
