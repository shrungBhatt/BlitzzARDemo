...
public class BlitzzCamera implements com.projects.shrungbhatt.blitzzardemo.utils.Camera, Camera.ErrorCallback {

    private static final String TAG = "BlitzzCamera";
    ...
    public BlitzzCamera(CameraCallback callback, int frameWidth, int frameHeight) {
