...
extern "C" JNIEXPORT void JNICALL Java_com_projects_shrungbhatt_blitzzardemo_utils_FrameInputPluginModule_nativeNotifyNewCameraFrameNV21(JNIEnv* env_, jobject, jlong nativeHandle_, jbyteArray data_) {
    auto module = reinterpret_cast<FrameInputPluginModule*>(nativeHandle_);
...
extern "C" JNIEXPORT void JNICALL Java_com_projects_shrungbhatt_blitzzardemo_utils_FrameInputPluginModule_nativeFieldOfViewChanged(JNIEnv*, jobject, jlong nativeHandle_, jfloat fov_) {
    auto module = reinterpret_cast<FrameInputPluginModule*>(nativeHandle_);
    module->fieldOfViewChanged(fov_);
}

extern "C" JNIEXPORT void JNICALL Java_com_projects_shrungbhatt_blitzzardemo_utils_FrameInputPluginModule_nativeCameraToSurfaceAngleChanged(JNIEnv*, jobject, jlong nativeHandle_, jfloat angle_) {
    auto module = reinterpret_cast<FrameInputPluginModule*>(nativeHandle_);
    module->cameraToSurfaceAngleChanged(angle_);
}

extern "C" JNIEXPORT void JNICALL Java_com_projects_shrungbhatt_blitzzardemo_utils_FrameInputPluginModule_nativeCameraReleased(JNIEnv*, jobject, jlong nativeHandle_) {
    auto module = reinterpret_cast<FrameInputPluginModule*>(nativeHandle_);
